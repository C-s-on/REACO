...
- Train the embedding model with the implementation of the Siamese network: Preprocessing images to a fixed size, preparing triplets, and using a pre-trained InceptionV3 model. The model was trained with triplet data, using the Adam optimizer.<p align='center'>  <img src="https://github.com/C-s-on/REACO/blob/main/gfx/Inception_Network.png" width="600"/> </p>
